...
if __name__ == "__main__":
    ...
    xodr_file = '/home/fanyi/dev_code/onsite/e2e/samples/maps/AITownReconstructed_V0103_200518.xodr'
    ...
    if os.path.exists(xodr_file):
        ...
        opendrive.findPath(784710.9, 3352894.1, 784523.1, 170.256, True, False)
