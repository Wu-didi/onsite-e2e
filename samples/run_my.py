...
from predictor_my import Predictor
...
def get_prepare():
    ...
    if ret >= 0 and msg.type() == MT_ACTOR_PREPARE:
        ...
        print("target_state: ", target_state["x"], target_state["y"])
        print("zjl_odv_file: ", brief_data["zjl_odv_file"])
        print(model.get_map_path())
        model.init_planner(model.get_map_path(), [init_state["x"], init_state["y"]], [target_state["x"], target_state["y"]])
...
def main():
    ...
    while 1:
        ...
        control_message = get_pointcloud_msg()
        # if cmd is None:
            # print("=============================cmd is none==============================================")
        ...
        if control_message  is not None:
            speed = 35
            print("control_message: ", control_message)
            control_message[1] = control_message[1] * 100
            send_control_cmd(control_message[0], speed, control_message[1]) # 发送控制命令
